...
const DirectorSection = () => (
    <div className="flex w-full flex-col items-center bg-[#f2f2f2] py-8">
      <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center rounded-[32px] bg-white px-4 py-16 shadow-sm tablet:px-16">
        <div className="flex flex-col items-center">
          ...
          <ScrollReveal as="h2" className="font-roboto mb-4 text-center text-[40px] font-bold tablet:text-[48px]">
...
const StatsSection = () => (
  <div className="flex w-full flex-col items-center bg-[#f2f2f2] py-0">
    <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center rounded-[32px] bg-white px-4 py-12 shadow-sm tablet:px-16">
      <ScrollReveal className="grid w-full grid-cols-2 gap-6 tablet:grid-cols-4">
        <div className="flex flex-col items-center">
