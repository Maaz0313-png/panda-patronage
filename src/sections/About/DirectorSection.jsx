    ...
    <div className="flex w-full flex-col items-center bg-[#f2f2f2] py-8">
      <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center rounded-[32px] bg-white px-4 py-16 shadow-sm md:px-16">
        <div className="flex flex-col items-center">
          <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-full border border-gray-200 bg-gray-300">
            <BsEmojiSmile className="text-2xl" />
          </div>
          <h2 className="font-roboto mb-4 text-center text-[40px] font-bold md:text-[48px]">
            Insights from Our Director
          </h2>
          <p className="font-roboto mb-8 max-w-2xl text-center text-lg text-gray-500">
