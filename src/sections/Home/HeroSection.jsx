...
const HeroSection = () => {
  ...
  return (
    <ScrollReveal className="relative flex w-full flex-row flex-nowrap items-center justify-center overflow-visible p-0">
      <section className="tablet:p-6 tablet:pb-20 desktop:pb-24 flex h-min w-full items-center justify-center bg-transparent p-4 pb-12">
        <div className="tablet:px-10 tablet:py-20 desktop:p-16 desktop:pt-[100px] desktop:grid-cols-2 tablet:grid-cols-12 relative grid w-full items-center rounded-xl [background-image:linear-gradient(116deg,_rgb(152,59,0)_0%,_rgb(92,36,0)_9%,_rgb(31,31,31)_31%)] px-4 py-14 shadow-lg">
          {/* Left: Text */}
          ...
          <div className="tablet:mt-0 desktop:w-full tablet:col-span-4 desktop:col-span-1 relative mt-10 flex min-h-[370px] items-center justify-center">
            {/* Panda image */}
            <motion.img
              src="/images/misc/panda-hero.png"
              alt="Panda with headphones"
              className="desktop:opacity-100 desktop:block desktop:h-[515px] desktop:w-[601px] absolute -right-16 -bottom-24 z-10 hidden cursor-grab rounded-br-3xl rounded-bl-3xl opacity-0"
              drag={true}
              dragElastic={1}
            ...
            <motion.img
              ...
              dragConstraints={{ left: 0, right: 0, top: 0, bottom: 0 }}
            />
            {/* Left [#1f1f1f] body - positioned over panda */}
            <motion.img
            ...
            />
            {/* Right [#1f1f1f] body - positioned over panda */}
            <motion.img
